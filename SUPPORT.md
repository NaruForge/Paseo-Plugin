...
**Current source targets 0.8.0-beta.1.** The three existing plugins have a user runtime verification report. Command Deck is a new Windows-only experimental source with [separate evidence and pending app verification](docs/verification/command-deck-0.8-source.md). For the existing plugins, the user reported runtime verification on Paseo 0.8; exact daemon/app versions, platforms and scenarios were not supplied. Follow the [reported scope](docs/verification/paseo-0.8-runtime.md), not an inferred beta.1 or native-platform certification. Git installation/update/recovery for the three existing plugins is recorded in the [Git source verification](docs/verification/paseo-0.8-git-source.md); Command Deck Git activation remains unverified. The published release remains on 0.7.2; see [Compatibility](docs/COMPATIBILITY.md).
