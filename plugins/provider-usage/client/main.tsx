...
import type { ProviderUsage, UsageBalance, UsageWindow } from "../shared/provider-usage";
    ...
    <View style={styles.card}>
      ...
      {provider.details?.map((detail) => (
        <View key={detail.id} style={styles.reading}>
          ...
          <Text style={styles.readingMeta}>{detail.value}</Text>
        </View>
      ))}
        ...
        <View style={styles.shell}>
          <View style={styles.intro}>
            <Text style={styles.description}>
              Usage for enabled Provider connections on the selected Host. This does not replace Settings →
              Usage.
            </Text>
