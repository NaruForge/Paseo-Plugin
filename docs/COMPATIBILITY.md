...
| Prompt Palette new source | 0.8.0-beta.1 | Unreleased; [source verification](verification/prompt-palette-0.8-source.md); no live daemon/app or Git activation checks |
...
| Future collection release | 0.8 target to be recorded | Live runtimes, Git activation/update and native RPC/UI checks for every included plugin pending |
